...
it('defines plugin_tags_install function', function () use ($source) {
	expect($source)->toContain('function plugin_tags_install');
});

it('defines plugin_tags_version function', function () use ($source) {
	expect($source)->toContain('function plugin_tags_version');
});

it('defines plugin_tags_uninstall function', function () use ($source) {
	expect($source)->toContain('function plugin_tags_uninstall');
});
